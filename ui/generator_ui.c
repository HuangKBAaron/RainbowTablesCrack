...
void print_usage() {
	printf("Usage: rbt_generate [--version] |\n");
	printf("                    [--kl max_password_length]\n");
	printf("                    [--min --may --num --special]\n");
	printf("                    [--cl chain_length]\n");
	printf("                    [--tl table_length]\n");
	printf("                    [--t tables_number]\n");
...
char *argv[];
{
	...
	static struct option long_options[] =
		{
			...
			{"kl",        required_argument, 0, 'k'},
			{"cl",        required_argument, 0, 'c'},
			{"tl",        required_argument, 0, 'l'},
	...
	if(strcmp(_charset, "") == 0){
		...
		*/
		// default charset
		strcat(_charset,  CHARSET_DEFAULT);
	}		
